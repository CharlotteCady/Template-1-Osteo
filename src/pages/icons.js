  ...
  return (
    <div>
      ...
      <section id="glyphs">
        ...
        <div className="glyph">
          <div className="glyph-icon flaticon-design-tool" />
          <div className="class-name">.flaticon-design-tool</div>
          <div className="author-name">
            Author:{' '}
            <a data-file="003-design-tool" href="http://www.freepik.com">
              Freepik
            </a>{' '}
          </div>
        </div>
        ...
        <div className="glyph">
          <div className="glyph-icon flaticon-project" />
          <div className="class-name">.flaticon-project</div>
          <div className="author-name">
            Author:{' '}
            <a data-file="006-project" href="http://www.freepik.com">
              Freepik
            </a>{' '}
          </div>
        </div>
        ...
        <div className="glyph">
          <div className="glyph-icon flaticon-quote" />
        ...
        <div className="glyph">
          <div className="glyph-icon flaticon-right-arrow" />
          <div className="class-name">.flaticon-right-arrow</div>
          <div className="author-name">
            Author:{' '}
            <a
        ...
        <div className="glyph">
          ...
          <div className="author-name">
            Author:{' '}
            <a data-file="021-facebook-logo" href="http://www.freepik.com">
              Freepik
            </a>{' '}
          </div>
        </div>
        ...
        <div className="glyph">
          <div className="glyph-icon flaticon-twitter" />
        ...
        <div className="glyph">
          ...
          <div className="author-name">
            Author:{' '}
            <a data-file="023-instagram" href="http://www.freepik.com">
              Freepik
            </a>{' '}
          </div>
        </div>
        ...
        <div className="glyph">
          <div className="glyph-icon flaticon-shield" />
          <div className="class-name">.flaticon-shield</div>
          <div className="author-name">
            Author:{' '}
            <a data-file="031-shield" href="http://www.freepik.com">
              Freepik
            </a>{' '}
          </div>
        </div>
        ...
        <div className="glyph">
          <div className="glyph-icon flaticon-cryptocurrency" />
          <div className="class-name">.flaticon-cryptocurrency</div>
          <div className="author-name">
            Author:{' '}
            <a
        ...
        <div className="glyph">
          ...
          <div className="author-name">
            Author:{' '}
            <a data-file="034-annonymous" href="http://www.freepik.com">
              Freepik
            </a>{' '}
          </div>
        </div>
      ...
      <section className="iconsuse">
        <div>
          ...
          <div className="image">
            <p>
              <i className="glyph-icon flaticon-design-tool" />
              <span>
